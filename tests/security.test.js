...
import { classifyCommand, isCommandAllowed, sanitizeArgs, validateDangerousFlags, sanitizeTinkerCode, isPathSafe, isWriteAllowed, maskEnvValues, } from "../src/utils/security.js";
...
test("Dangerous Flags Check", () => {
    ...
    assert.throws(() => validateDangerousFlags("db:seed", ["--drop-tables"]), /Prohibited/);
    // Valid flags
